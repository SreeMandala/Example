...
public class UserController {
  ...
  public ResponseEntity<User> read(@PathVariable String emailId) {
  ...
  public ResponseEntity<User> put(@PathVariable String emailId, @RequestBody User user) {
  ...
  public ResponseEntity<User> patch(@PathVariable String emailId, @RequestBody User user) {
